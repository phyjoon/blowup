...
\end{align}
where $\omega = i\partial\bar{\partial}\log(|z|^2+|w|^2)$ is the Fubini-Study two-form on the exceptional divisor $C$. The zero-form $H$ denotes the corresponding $U(1)^2$ moment map, written explicitly in \eqref{eq:moment-map}.
...
\end{align}
The 5d version of the equivariant Donaldson operator \eqref{eq:muC} was constructed in \cite{Baulieu:1997nj},  \textcolor{red}{complete}
