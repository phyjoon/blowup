...
We obtain the partition function for the previously unknown theories such as exceptional gauge groups $EFG$ with fundamental and $SO(N)$ theories with spinor hypermultiplets. We also compute the case with $SU(6)$ with rank-3 antisymmetric tensor and compare with the topological vertex computation using the recently found 5-brane web configuration. 
}
...
% The 1-instanton partition function for the pure YM theory with exceptional gauge groups has been studied in \cite{VinbergPopov, Garfinkle, Benvenuti:2010pq, Keller:2011ek, Keller:2012da} and two instanton partition function has been studied in \cite{Gaiotto:2012uq, Keller:2012da, Hanany:2012dm}. 
