...
After some work, it is not hard to convince that $A(k, p_1, p_2)$ can be written in terms of a finite sum. Upon taking the PE, we obtain
\begin{align}
\textrm{PE}\left[ e^{x} A(k, e^{\e_1}, e^{\e_2}) \right] = 
\begin{cases}
